...
from lidenbrock.core import decide
...
from lidenbrock.core.pairing import ends_with_break_mark, forward_ref, pair_ref
from lidenbrock.core.reconcile import _lookup_ref
from lidenbrock.core.traces import _set_trace
from lidenbrock.core.units import derive_hyphen_groups, hyphen_group_by_line
...
class _FinalizeOrder:
    ...
    ``RuntimeError`` — deliberately NOT a ``LidenbrockError``, which the
