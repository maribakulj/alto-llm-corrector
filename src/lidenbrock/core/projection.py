...
from lidenbrock.core.fidelity import ProjectionFidelity, classify_projection_fidelity
from collections.abc import Mapping

from lidenbrock.core.identity import LineRef, line_ref
from lidenbrock.core.schemas import LineTrace, PageManifest
...
def _verify_projection(
    ...
    :class:`~lidenbrock.core.fidelity.ProjectionFidelity`) so the caller
