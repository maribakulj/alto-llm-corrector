...
from lidenbrock.core.units import derive_hyphen_groups
...
def _lookup_ref(
    ...
    *,
    ...
    :mod:`lidenbrock.core.pairing`'s primitives before we get here. This
...
def _unit_pool(
    ...
    them into one pool lets :func:`~lidenbrock.core.units.units_containing`
