...
from lidenbrock.core.projection import _verify_projection
...
from lidenbrock.core.schemas import DocumentManifest, LineTrace, PageManifest
...
async def _rewrite_and_verify(
    ...
    *,
    ...
    disappearing.
    """
    from lidenbrock import __version__ as _lib_version
