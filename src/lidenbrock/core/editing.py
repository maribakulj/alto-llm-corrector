...
from lidenbrock.core._norm import has_line_separator
...
class ReplaceLine(BaseModel):
    ...
    #: :class:`~lidenbrock.core.schemas.LineConfidence`. Optional and
...
def apply_edit_script(
    ...
    *,
    ...
    ``protocol_version`` raises :class:`~lidenbrock.errors.ProposalValidationError`
