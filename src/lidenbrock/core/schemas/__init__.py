...
``from lidenbrock.core.schemas import X`` keeps working for every X it
ever named, and the split cost no importer a line.

  :mod:`~lidenbrock.core.schemas.manifest`   the parsed document
  :mod:`~lidenbrock.core.schemas.policies`   what a consumer injects (§8.2)
  :mod:`~lidenbrock.core.schemas.producer`   the producer payloads (§5.1)
  :mod:`~lidenbrock.core.schemas.report`     what the run says it did (§9)
...
from lidenbrock.core.fidelity import ProjectionFidelity as ProjectionFidelity

from lidenbrock.core.schemas.manifest import (
...
from lidenbrock.core.schemas.policies import (
...
from lidenbrock.core.schemas.producer import (
...
from lidenbrock.core.schemas.report import (
