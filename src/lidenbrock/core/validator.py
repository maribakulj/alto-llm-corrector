...
from lidenbrock.core._norm import has_line_separator, ncfold
from lidenbrock.errors import ProposalValidationError
from lidenbrock.core.pairing import strip_trailing_break_marks
...
class HyphenIntegrityError(ProposalValidationError):
    ...
    Subclass of :class:`lidenbrock.errors.ProposalValidationError` (itself a
    ``LidenbrockError`` and a ``ValueError``, §8.4) so existing
