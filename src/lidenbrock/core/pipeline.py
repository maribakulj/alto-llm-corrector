...
Protocols in :mod:`lidenbrock.core.protocols` — no job store, no
...
from lidenbrock.core.redaction import sanitize_error
from lidenbrock.core.context import RunContext
from lidenbrock.core.driver import PageDriver
from lidenbrock.core.finalize import _finalize_document
from lidenbrock.core.indexing import (
    DocumentIndex,
    _cross_page_partners,
    _index_document,
)
from lidenbrock.core.preflight import _preflight
from lidenbrock.core.rendering import _render_outputs
from lidenbrock.core.report import _build_correction_report
from lidenbrock.core.result import CorrectionResult, _build_correction_result
from lidenbrock.core.provenance import (
...
from lidenbrock.core.confidence import (
    ConfidenceScorer,
    HeuristicScorer,
)
...
class CorrectionPipeline:
    ...
    async def run(
        ...
        **Immutability & reentrancy (ADR-011 slice E, retiring
        ...
        :class:`~lidenbrock.core.schemas.ImageAsset` — one image per
