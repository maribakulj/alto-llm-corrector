...
:class:`~lidenbrock.core.result.CorrectionResult` before returning.
"""
...
from lidenbrock.core.editing import EditOp
from lidenbrock.core.hyphenation import ReconcileMetrics
from lidenbrock.core.identity import LineRef
from lidenbrock.core.schemas import HyphenSplit, PageImage, Usage
