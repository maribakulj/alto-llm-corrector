...
its own name (:class:`~lidenbrock.core.schemas.LineConfidence`): the
...
from lidenbrock.core.alignment import TokenAlignment, align_tokens, char_similarity
from lidenbrock.core.schemas import LineConfidence
