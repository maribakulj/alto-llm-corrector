...
from lidenbrock.formats._xml import classified_parse_errors
...
def parse_alto_file(
    ...
    as :class:`~lidenbrock.errors.ParseError` (ADR-008), never as a
...
def _parse_alto_file(
    ...
    # See lidenbrock.formats.alto._ns.make_safe_parser docstring.
