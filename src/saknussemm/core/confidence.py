...
its own name (:class:`~saknussemm.core.schemas.LineConfidence`): the
...
from saknussemm.core.alignment import TokenAlignment, align_tokens, char_similarity
from saknussemm.core.schemas import LineConfidence
