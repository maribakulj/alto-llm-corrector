...
and confusion signals + optional lexicon coverage); the ``saknussemm[qe]``
...
from saknussemm.core.schemas import FrozenPolicy
...
class HeuristicQEScorer:
    ...
    correction" signal here — saknussemm PRESERVES historical
