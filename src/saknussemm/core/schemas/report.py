...
class ProjectionStage(BaseModel):
    ...
    #: :class:`~saknussemm.core.fidelity.ProjectionFidelity`. ``exact`` when
...
class ProducerProvenance(BaseModel):
    ...
    Mirrors :class:`saknussemm.core.protocols.ProducerMetadata` field for
