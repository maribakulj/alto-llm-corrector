...
from corrigenda.core.hyphenation import _part1_text_migrated
...
class TestThePredicates:
    ...
    def test_the_predicate_does_not_re_impose_the_alphabetic_heuristic(self) -> None:
        ...
        from corrigenda.core.pairing import trailing_hyphen_char
...
class TestAnEmptyLineIsNotAPartner:
    ...
    def _page(texts: list[str]):
        from corrigenda.core.schemas import Coords, LineManifest, PageManifest
    ...
    def _linked(self, texts: list[str]):
        ...
        from corrigenda.formats.page.parser import _assign_hyphen_roles
...
class TestAnEmptyLineAtAPageSeam:
    ...
    def _link(self, first: list[str], second: list[str]):
        from corrigenda.core.pairing import link_cross_page_hyphens
        from corrigenda.core.schemas import PairingPolicy
        from corrigenda.formats.page.parser import _assign_hyphen_roles
