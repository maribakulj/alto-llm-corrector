...
from corrigenda.core.schemas import CorrectionReport, RetryPolicy
...
def test_the_invariant_actually_catches_the_l9_shape() -> None:
    ...
    """
    from corrigenda.core.schemas import DecisionStage, LineOutcome, ProposalStage
...
def test_the_invariant_catches_a_fallback_that_changed_the_text() -> None:
    from corrigenda.core.schemas import DecisionStage, LineOutcome
