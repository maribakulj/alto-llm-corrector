...
from corrigenda.core.schemas import DocumentManifest, HyphenRole
from corrigenda.formats.alto.parser import (
    build_document_manifest as build_alto_manifest,
)
from corrigenda.formats.alto.rewriter import extract_output_texts as extract_alto_texts
from corrigenda.formats.page.parser import (
    build_document_manifest as build_page_manifest,
)
from corrigenda.formats.page.rewriter import extract_output_texts as extract_page_texts
