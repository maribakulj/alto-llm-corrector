...
``from corrigenda.core.schemas import X`` keeps working for every X it
ever named, and the split cost no importer a line.

  :mod:`~corrigenda.core.schemas.manifest`   the parsed document
  :mod:`~corrigenda.core.schemas.policies`   what a consumer injects (§8.2)
  :mod:`~corrigenda.core.schemas.producer`   the producer payloads (§5.1)
  :mod:`~corrigenda.core.schemas.report`     what the run says it did (§9)
...
from corrigenda.core.fidelity import ProjectionFidelity as ProjectionFidelity

from corrigenda.core.schemas.manifest import (
...
from corrigenda.core.schemas.policies import (
...
from corrigenda.core.schemas.producer import (
...
from corrigenda.core.schemas.report import (
