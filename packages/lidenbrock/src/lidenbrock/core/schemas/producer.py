...
from lidenbrock.core.schemas.manifest import ChunkGranularity, Coords
...
class ImageTransform(BaseModel):
    ...
    pixel); the ``lidenbrock[vision]`` producer applies it. Rotation
...
class ImageAsset(BaseModel):
    ...
    ``lidenbrock[vision]`` builder decodes the image and fills them in; a
