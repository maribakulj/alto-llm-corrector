...
from lidenbrock.core.schemas.policies import HyphenSplit
from lidenbrock.core.schemas.producer import Usage
...
class ProjectionStage(BaseModel):
    ...
    #: :class:`~lidenbrock.core.fidelity.ProjectionFidelity`. ``exact`` when
...
class ProducerProvenance(BaseModel):
    ...
    Mirrors :class:`lidenbrock.core.protocols.ProducerMetadata` field for
