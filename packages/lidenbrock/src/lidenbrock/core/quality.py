...
and confusion signals + optional lexicon coverage); the ``lidenbrock[qe]``
...
from lidenbrock.core.schemas import FrozenPolicy
...
class HeuristicQEScorer:
    ...
    correction" signal here — lidenbrock PRESERVES historical
