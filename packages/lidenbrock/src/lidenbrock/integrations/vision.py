"""Pixel-pure vision toolkit — the deterministic half of ``lidenbrock[vision]``.
...
* the forthcoming ``VisionEditProducer`` is the thin, non-deterministic
  ...
  into an :class:`~lidenbrock.core.editing.EditScript`.
...
:class:`~lidenbrock.core.schemas.ImageAsset`; this module is what decodes
...
from lidenbrock.core.confidence import DEFAULT_CONFUSIONS
from lidenbrock.core.editing import EditScript
from lidenbrock.core.protocols import ProducerMetadata, ProducerOptions
...
class VisionEditProducer:
    ...
    (:func:`~lidenbrock.integrations.llm.edit_ops_from_response`) the text
    ...
    frame and transform) — a bare :class:`~lidenbrock.core.schemas.ImageRef`
