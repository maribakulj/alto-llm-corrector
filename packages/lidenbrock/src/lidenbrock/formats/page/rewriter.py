...
from lidenbrock.core._norm import nfc
from lidenbrock.core.identity import ensure_unique_identities
from lidenbrock.core.losses import COUNTS_INVALIDATION, INVALIDATION_COUNTER
...
from lidenbrock.core.schemas import LineManifest, PageManifest
...
from lidenbrock.formats.page._text import (
    canonical_line_text,
    canonical_textequiv,
    word_text,
)
...
class PageRewriterMetrics:
    ...
    #: event. See :mod:`lidenbrock.core.losses`.
