...
What stayed behind in :mod:`lidenbrock.core.losses` is what BOTH formats
read and neither owns: the two fates an attribute can have
(:class:`~lidenbrock.core.losses.AttributeClass`,
:class:`~lidenbrock.core.losses.AttributeFate`), the decision to count
