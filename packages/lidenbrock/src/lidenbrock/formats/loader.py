...
not a refusal. ``lidenbrock.load()`` (the facade) is this module plus
...
from lidenbrock.core.protocols import FormatAdapter
...
def adapter_for_format(source_format: str | None) -> FormatAdapter:
    ...
    if source_format == "page":
        from lidenbrock.formats.page.adapter import PageFormatAdapter
    ...
    raise ConfigurationError(
        ...
        "lidenbrock format parser, or inject format_adapter explicitly "
        "on the pipeline"
    )
